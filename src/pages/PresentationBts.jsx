        ...
        <>
            <div className="w-11/12 mx-auto my-2">
                ...
                <div id="bts" className="mt-2">
                    <p>
                        Le BTS <abbr title="Services Informatiques aux Organisations">S.I.O.</abbr> est un diplôme de deux ans qui permet aux étudiants d&apos;acquérir des compétences pour la mise en place de solutions informatiques au sein des organisations. :  
                    </p>
                    <dl className="my-1">
                ...
                <div className="flex flex-col mt-2 justify-evenly md:flex-row">
                    <div id="sisr" className="p-2 rounded-md shadow-sm shadow-slate-300 bg-slate-100 md:mx-2 md:w-4/12 h-5/6">
                        ...
                        <div className="mt-1 ml-2">
                            <p>L&apos;option S.I.S.R., a pour but de former des techniciens spécialisés dans l&apos;installation, la gestion et la maintenance des infrastructure réseaux et des systèmes Informatiques.</p>
                            <p className="mt-1">Les compétences développées par le technicien sont : </p>
